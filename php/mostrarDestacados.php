...
$query = "SELECT propiedades.titulo, propiedades.descripcion, propiedades.precio, propiedades.tipo, imagenes.direccion AS imagen, usuarios.nombre AS nombre_usuario
    FROM propiedades 
